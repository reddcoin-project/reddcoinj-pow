...
import com.google.reddcoin.params.TestNet2Params;
...
public class BlockTest {
    ...
    public void testJavaSerialiazation() throws Exception {
        ...
        // Note that this will actually check the transactions are equal by doing reddcoin serialization and checking
