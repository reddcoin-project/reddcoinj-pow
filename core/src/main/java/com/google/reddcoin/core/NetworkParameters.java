...
public abstract class NetworkParameters implements Serializable {
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            byte[] bytes = Hex.decode
                    ("04ffff001d0104284a616e75617279203231737420323031342077617320737563682061206e696365206461792e2e2e");
            t.addInput(new TransactionInput(n, t, bytes));
            ByteArrayOutputStream scriptPubKeyBytes = new ByteArrayOutputStream();
            Script.writeBytes(scriptPubKeyBytes, Hex.decode
                    ("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9"));
            scriptPubKeyBytes.write(ScriptOpCodes.OP_CHECKSIG);
            t.addOutput(new TransactionOutput(n, t, Utils.toNanoCoins(10000, 0), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
    ...
    public static final int TARGET_TIMESPAN = (int)(1 * 60);  // 4h per difficulty cycle, on average.
     ...
     */
    public static final BigInteger MAX_MONEY = new BigInteger("109000000000", 10).multiply(COIN);
